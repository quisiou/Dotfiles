...
function M.load()
    ...
    hl("@field",              { fg = c.SECONDARY })

    hl("@function",          { fg = c.WARNING })
    hl("@function.builtin",  { fg = c.SECONDARY_MUTED })
    hl("@function.call",     { fg = c.WARNING })
    hl("@method",            { fg = c.WARNING })
    hl("@method.call",       { fg = c.WARNING })
    ...
    hl("@keyword.operator",  { fg = c.WARNING })
    ...
    hl("@punctuation.bracket",  { fg = c.TERTIARY })
    hl("@punctuation.delimiter",{ fg = c.TERTIARY })
    ...
    hl("@boolean",           { fg = c.SECONDARY })
    hl("@constant",          { fg = c.ACCENT_LOW, bold = true })
    hl("@constant.builtin",  { fg = c.ACCENT_LOW, italic = true, bold = true})
